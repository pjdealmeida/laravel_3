...
<x-forms.post action="wizard/post-form/" class="form form-account cozy" name="form-personal" id="form-step-2">
    <div class="row">
        <div class="form-group col-md-6">
            <label for="personal_title" class="small bold">Title</label>
            <select name="Personal[title]" id="personal_title" class="form-select" required>
        ...
        <div class="form-group col-md-6">
            ...
            <select name="Personal[gender]" id="personal_gender" class="form-select" required>
    ...
    <div class="form-group">
        <label for="personal_address2" class="form-label">Address 2</label>
    ...
    <div class="form-group">
        ...
        <select name="Personal[country]" id="personal_country" class="form-select" required>
