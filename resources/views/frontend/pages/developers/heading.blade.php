...
<header class="header section parallax image-background overlay overlay-primary alpha-8 text-contrast"
    style="background-image: url('{{ asset("img/bg/grid.jpg") }}')">
    <div class="container overflow-hidden">
        <div class="row">
            <div class="col-md-8">
                <p class="lead bold">Welcome Developers!</p>
                <h1 class="display-4 text-contrast light">Tools for your day-to-day</h1>
                <h1 class="text-contrast"><span class="typed bold display-4 display-md-3" data-strings='["Invoicing", "Subscriptions", "Mailing", "Reporting"]'></span></h1>
